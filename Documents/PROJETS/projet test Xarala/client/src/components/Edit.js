...
function Edit() {
    ...
    return ( 
        <div>
            ...
            <input className="input" type='number' onChange={(e) => onValueChange(e)} name='phone' type="phone" value={phone} id="my-input" aria-describedby="my-helper-text" />
            <br/><br/>
            ...
            <input className="input" type='text' onChange={(e) => onValueChange(e)} name='image' type="phone" value={image} id="my-input" aria-describedby="my-helper-text" />
            <br/><br/>
